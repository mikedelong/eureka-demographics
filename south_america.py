...
if __name__ == '__main__':
    ...
    latin_america_df =  df[(df['Parent code'] == 904) | (df['Location code'] == 904)][['Year', 'Region, subregion, country or area *',
    ...
    latin_america_df['Region'] = latin_america_df['Region'].replace({'LATIN AMERICA AND THE CARIBBEAN': 'LATIN AMERICA'})
